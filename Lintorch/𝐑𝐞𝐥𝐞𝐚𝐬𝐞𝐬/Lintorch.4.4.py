...
print("| Latest news: Get your Lintorch Gold Edition now from GitHub.")

time.sleep(1)

print("\033[34mLintorch is made by Leonxzy. For any technical issues or bugs, contact: leon.hodzic@outlook.com\033[0m")
